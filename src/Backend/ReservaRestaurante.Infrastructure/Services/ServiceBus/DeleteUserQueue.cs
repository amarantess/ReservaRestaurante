...
namespace ReservaRestaurante.Infrastructure.Services.ServiceBus
{
	public class DeleteUserQueue : IDeleteUserQueue
	{
		private readonly ServiceBusSender _serviceBusSender;

		public DeleteUserQueue(ServiceBusSender serviceBusSender) => _serviceBusSender = serviceBusSender; 
